...
latex_documents = [
    (master_doc, 'manual.tex', 'CaPS Documentation',
...
man_pages = [
    (master_doc, 'caps', 'CaPS Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'caps', 'CaPS Documentation',
     author, 'CaPS', 'Casimir effect in the plane-sphere geometry.',
     'Miscellaneous'),
]
