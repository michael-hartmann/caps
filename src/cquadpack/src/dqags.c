...
{
    double abseps = 0,alist[LIMIT] = { 0 }, area = 0, area1 = 0, area12 = 0, area2 = 0;
    double a1 = 0,a2 = 0, blist[LIMIT] = { 0 }, b1 = 0,b2 = 0,correc = 0, defabs = 0, defab1 = 0;
    double defab2 = 0, dres = 0, elist[LIMIT] = { 0 }, erlarg = 0, erlast = 0, errbnd = 0;
    double errmax = 0, error1 = 0, error2 = 0, erro12 = 0, errsum = 0, ertest = 0;
    double resabs = 0, reseps = 0, result = 0, res3la[3] = { 0 }, rlist[LIMIT] = { 0 };
