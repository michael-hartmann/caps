/*
 * This file was partly generated by src/tests/test_mie_drude.py. However, as
 * mpmath returns sometimes inaccurate results, the output of the script was
 * modified against. In cases where our results differed from the mpmath
 * results, Mathematica was used to obtain the correct results.
 */
