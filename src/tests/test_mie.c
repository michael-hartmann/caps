...
int test_caps_mie_perf(void)
{
    double lna, lnb;
    unittest_t test;
    unittest_init(&test, "caps_mie_perf", "Mie coefficients (PR)", 1e-14);

    caps_t *self = caps_init(1,1);

    caps_mie_perf(self, 6, 3, &lna, &lnb);
    ...
    caps_mie_perf(self, 200, 100, &lna, &lnb);
    ...
    caps_mie_perf(self, 400, 100, &lna, &lnb);
    ...
    caps_mie_perf(self, 600, 100, &lna, &lnb);
    ...
    caps_mie_perf(self, 0.02, 40, &lna, &lnb);
    ...
    caps_mie_perf(self, 0.02, 4, &lna, &lnb);
    ...
    caps_mie_perf(self, 2, 100, &lna, &lnb);
    ...
    caps_mie_perf(self, 2, 200, &lna, &lnb);
    ...
    caps_mie_perf(self, 2, 500, &lna, &lnb);
    ...
    caps_mie_perf(self, 2, 1000, &lna, &lnb);
    ...
    caps_mie_perf(self, 2, 1500, &lna, &lnb);
    ...
    caps_mie_perf(self, 2, 2000, &lna, &lnb);
    ...
    caps_mie_perf(self, 2, 4000, &lna, &lnb);
    ...
    caps_mie_perf(self, 2, 6000, &lna, &lnb);
    ...
    caps_mie_perf(self, 2, 8000, &lna, &lnb);
    ...
    caps_mie_perf(self, 4, 8000, &lna, &lnb);
    ...
    caps_mie_perf(self, 20, 8000, &lna, &lnb);
    ...
    caps_mie_perf(self, 200, 8000, &lna, &lnb);
    ...
    caps_mie_perf(self, 2000, 8000, &lna, &lnb);
    ...
    caps_mie_perf(self, 0.2, 8000, &lna, &lnb);
    ...
    caps_mie_perf(self, 0.02, 8000, &lna, &lnb);
    ...
    caps_mie_perf(self, 0.002, 8000, &lna, &lnb);
    ...
    caps_mie_perf(self, 4, 70, &lna, &lnb);
    ...
    caps_mie_perf(self, 140, 70, &lna, &lnb);
    ...
    caps_mie_perf(self, 200, 70, &lna, &lnb);
    ...
    caps_mie_perf(self, 0.4, 7, &lna, &lnb);
    ...
    caps_mie_perf(self, 0.2, 20, &lna, &lnb);
    ...
    caps_mie_perf(self, 0.02, 20, &lna, &lnb);
    ...
    caps_mie_perf(self, 0.02, 30, &lna, &lnb);
    ...
    caps_mie_perf(self, 0.002, 30, &lna, &lnb);
