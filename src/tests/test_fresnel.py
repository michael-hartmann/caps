...
if __name__ == "__main__":
    ...
    print("/* automatically generated by src/tests/test_fresnel.py */")
    print()
    ...
    for omegap_eV in (0.01, 1, 10, 100, 1000):
        for gamma_eV in (1e-5, 0.001, 0.003, 0.035, 0.05, 0.1, 1):
            ...
            print()
            for xi_ in (1e-6, 1e-3, 1e-1, 1, 1e1, 1e3, 1e6):
                xi = xi_*c/(R+L)
                for k_ in (1e-6, 1e-3, 1e-1, 1, 1e1, 1e3, 1e6):
                    k = k_/(R+L)
