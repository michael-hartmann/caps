...
if __name__ == "__main__":
    ...
    print("/* file was automatically generated by src/tests/test_Mie_drude.py */")
    print("#include \"libcaps.h\"")
    print("#include \"unittest.h\"")
    print()
    print("#include \"test_mie_drude.h\"")
    print()
    print("int test_caps_mie(void)")
    print("{")
    ...
    print()
    print("    unittest_init(&test, \"caps_mie\", \"Mie coefficients (Drude)\", 1e-11);")
    print()
    print("    double R = 100e-6, L = 100e-6;")
    print("    caps = caps_init(R,L);")


    for omegap,gamma in ((50000,1),(5000,1), (500,1), (100,1), (50,1), (1,1)):
        print("    userdata[0] = %g*CAPS_c/(L+R); userdata[1] = %g*CAPS_c/(L+R);" % (omegap,gamma))
        ...
        for nT in (1e-4, 1e-3, 1e-2, 0.1, 0.5, 1, 2, 10, 100, 1000, 10000, 100000):
            for l in (1, 2, 3, 5, 10, 100, 500, 1000, 5000):
                try:
                    ...
                    print("    caps_mie(caps, %g, %d, &lna, &lnb);" % (nT,l))
